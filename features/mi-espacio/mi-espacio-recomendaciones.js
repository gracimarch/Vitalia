    ...
    function mostrarEmptyState() {
        ...
        btn.addEventListener('click', async () => {
            ...
            btn.innerHTML = `
                ...
                </svg> Generando recomendaciones...`;
            if (msg) {
                msg.innerHTML = '⏳ El servidor se está activando, esto puede tardar <strong>hasta 60 segundos</strong> la primera vez. Espera un momento...';
                msg.style.color = '#888';
            }
            ...
            try {
                ...
                btn.innerHTML = `
                    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" style="margin-right: 8px;">
                        <path fill-rule="evenodd" d="M14 2.5a.5.5 0 0 0-.5-.5h-6a.5.5 0 0 0 0 1h4.793L2.146 13.146a.5.5 0 0 0 .708.708L13 3.707V8.5a.5.5 0 0 0 1 0z"/>
                    </svg> Generar mis recomendaciones`;
            }
        });
    }
