...
// Framer Motion globals are usually under window.Motion in UMD builds
const { motion, useMotionValue, useAnimationFrame, useTransform } = window.Motion;

const GradientText = ({
    children,
    className = '',
    colors = ['#E1947F', '#9d60cf', '#80CACD'], // Default to footer colors
    animationSpeed = 8,
    showBorder = false,
