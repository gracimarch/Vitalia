    ...
    document.querySelectorAll('.audio-button').forEach(button => {
        button.addEventListener('click', function () {
            ...
            if (currentAudio && currentAudio !== audio) {
                currentAudio.pause();
                currentAudioButton.querySelector('img').src = '/assets/images/ui/reproducir-icono-meditaciones.webp';
            }

            // Reproducir o pausar el audio
            if (audio.paused) {
                audio.play();
                playPauseBtnImg.src = '/assets/images/ui/pausar-icono-meditaciones.webp';
                currentAudio = audio;
                currentAudioButton = button;
            } else {
                audio.pause();
                playPauseBtnImg.src = '/assets/images/ui/reproducir-icono-meditaciones.webp';
                currentAudio = null;
