...
export const ParticleCard = ({
  ...
  onMouseMove,
  onMouseLeave,
  enableSpotlight: _enableSpotlight,
  enableBorderGlow: _enableBorderGlow,
  enableStars: _enableStars,
  ...rest
}: any) => {
  ...
  useEffect(() => {
    ...
    const handleMouseLeaveInner = (e: MouseEvent) => {
    ...
    element.addEventListener('mousemove', handleMouseMoveInner);
    ...
    return () => {
      ...
      element.removeEventListener('mousemove', handleMouseMoveInner);
          ...
          if (enableStars) {
            return (
              ...
              >
                ...
                <h3 className="magic-bento-card__title" style={{ color: '#333', fontWeight: 'bold' }}>{card.title}</h3>
