...
const PricingCard = ({ plan }: { plan: typeof pricingData[0] }) => {
    ...
    >
      <div>
        ...
        <div style={{ display: 'flex', alignItems: 'baseline', marginBottom: '1rem' }}>
          ...
          {plan.period && (
            <span style={{ fontSize: '0.9rem', color: '#666', marginLeft: '5px' }}>{plan.period}</span>
          )}
        </div>
        ...
        <ul style={{ listStyle: 'none', padding: 0, margin: 0, textAlign: 'left' }}>
          {plan.features.map((feature, i) => (
            ...
            >
              <span style={{ color: `rgba(${glowColor}, 1)`, marginRight: '8px', fontSize: '0.9rem' }}>
                ✔
              </span>
              {feature}
            </li>
